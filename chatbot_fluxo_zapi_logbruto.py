...
print("🟢 Versão ATIVA: chatbot_fluxo_zapi_logbruto.py iniciada com sucesso")
...
def webhook():
    print(f"Raw body: {request.data}")  # loga o corpo cru da requisição
    try:
        data = request.get_json()
        print(f"Payload interpretado: {data}")
